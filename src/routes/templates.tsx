...
export const Route = createFileRoute("/templates")({
  head: () => ({ meta: [{ title: "Templates — Vanta UI" }, { name: "description", content: "Vanta UI templates." }] }),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-16">
      <h1 className="text-4xl font-medium tracking-tight capitalize">templates</h1>
