...
const Stage = ({ children, h = "min-h-[220px] sm:min-h-[280px]", pad = "p-4 sm:p-8", className = "" }: any) => (
...
export function Preview({ kind, variant, interactive = true }: { kind: string; variant?: string; interactive?: boolean }) {
  ...
  switch (kind) {
    ...
    case "popover": content = <Popover/>; break;
    case "dropdown": content = <Dropdown/>; break;
    case "context-menu": content = <ContextMenu/>; break;
    case "menu-bar": content = <MenuBar/>; break;
    case "command-menu": content = <CommandMenuP/>; break;
    case "modal": content = <Modal variant={variant}/>; break;
    case "drawer": content = <Drawer variant={variant}/>; break;
    case "hover-card": content = <HoverCard/>; break;
    case "navbar": content = <Navbar variant={variant}/>; break;
    case "sidebar": content = <Sidebar/>; break;
    case "tabs": content = <Tabs variant={variant}/>; break;
    case "accordion": content = <Accordion/>; break;
    case "collapse": content = <Collapse/>; break;
    case "breadcrumb": content = <Breadcrumb/>; break;
    case "pagination": content = <Pagination/>; break;
    case "stepper": content = <Stepper/>; break;
    case "dock": content = <Dock/>; break;
    case "floating-menu": content = <FloatingMenu/>; break;
    case "user-menu": content = <UserMenu variant={variant}/>; break;
    case "card": content = <Card variant={variant}/>; break;
    case "toast": content = <Toast variant={variant}/>; break;
    case "alert": content = <Alert variant={variant}/>; break;
    case "banner": content = <Banner/>; break;
    case "progress": content = <Progress variant={variant}/>; break;
    case "skeleton": content = <Skeleton/>; break;
    case "loader": content = <Loader variant={variant}/>; break;
    case "input": content = <Input variant={variant}/>; break;
    case "textarea": content = <Textarea/>; break;
    case "otp": content = <OTP variant={variant}/>; break;
    case "checkbox": content = <Checkbox variant={variant}/>; break;
    case "radio": content = <Radio/>; break;
    case "switch": content = <Switch/>; break;
    case "slider": content = <Slider variant={variant}/>; break;
    case "select": content = <Select variant={variant}/>; break;
    case "date": content = <DatePicker variant={variant}/>; break;
    case "form": content = <Form variant={variant}/>; break;
    case "field": content = <Field variant={variant}/>; break;
    case "upload": content = <Upload variant={variant}/>; break;
    case "color-picker": content = <ColorPicker/>; break;
    case "rating": content = <Rating/>; break;
    case "table": content = <Table variant={variant}/>; break;
    case "list": content = <List variant={variant}/>; break;
    case "grid": content = <Grid/>; break;
    case "tree": content = <Tree variant={variant}/>; break;
    case "timeline": content = <Timeline/>; break;
    case "feed": content = <Feed variant={variant}/>; break;
    case "stats": content = <Stats variant={variant}/>; break;
    case "empty": content = <Empty/>; break;
    case "divider": content = <Divider variant={variant}/>; break;
    case "kanban": content = <Kanban/>; break;
    case "hero": content = <Hero variant={variant}/>; break;
    case "feature-section": content = <FeatureSection variant={variant}/>; break;
    case "pricing-section": content = <PricingSection variant={variant}/>; break;
    case "faq": content = <FAQ/>; break;
    case "testimonial": content = <Testimonial variant={variant}/>; break;
    case "cta": content = <CTA/>; break;
    case "newsletter": content = <Newsletter/>; break;
    case "logo-strip": content = <LogoStrip/>; break;
    case "header": content = <Header/>; break;
    case "footer": content = <Footer/>; break;
    case "dashboard-shell": content = <DashboardShell/>; break;
    case "split-view": content = <SplitView/>; break;
    case "masonry": content = <Masonry variant={variant}/>; break;
    case "terminal": content = <Terminal/>; break;
    case "code-block": content = <CodeBlock/>; break;
    case "gallery": content = <Gallery/>; break;
    case "carousel": content = <Carousel variant={variant}/>; break;
    case "marquee": content = <Marquee variant={variant}/>; break;
    case "video": content = <Video/>; break;
    case "audio": content = <Audio/>; break;
    case "map": content = <Map/>; break;
    case "cursor": content = <Cursor/>; break;
    case "parallax": content = <Parallax/>; break;
    case "scroll-reveal": content = <ScrollReveal variant={variant}/>; break;
    case "beam": content = <Beam/>; break;
    case "aurora": content = <Aurora/>; break;
    case "grid-beam": content = <GridBeam/>; break;
    case "particles": content = <Particles/>; break;
    case "ticker": content = <Ticker variant={variant}/>; break;
    case "infinite-scroll": content = <InfiniteScroll/>; break;
    case "dnd": content = <DnD/>; break;
    case "chat": content = <Chat variant={variant}/>; break;
    case "theme-switcher": content = <ThemeSwitcher variant={variant}/>; break;
    case "swatch": content = <Swatch/>; break;
    case "typescale": content = <TypeScale/>; break;
    case "spacing-scale": content = <SpacingScale/>; break;
    case "icons": content = <Icons/>; break;
    case "responsive-preview": content = <ResponsivePreview/>; break;
    case "chart": content = <Chart variant={variant}/>; break;
    case "logo": content = <Logo/>; break;
    // v2 — AI
    case "ai-profile": content = <AIProfile variant={variant}/>; break;
    case "ai-agent": content = <AIAgent variant={variant}/>; break;
    case "ai-persona": content = <AIPersona/>; break;
    case "ai-prompt-card": content = <AIPromptCard variant={variant}/>; break;
    case "ai-tool-call": content = <AIToolCall/>; break;
    case "ai-citation": content = <AICitation/>; break;
    case "ai-suggestion": content = <AISuggestion/>; break;
    case "ai-model-picker": content = <AIModelPicker/>; break;
    case "ai-stream": content = <AIStream/>; break;
    case "ai-memory": content = <AIMemory/>; break;
    case "ai-token-usage": content = <AITokenUsage/>; break;
    // v2 — Data / Dashboard
    case "kpi-tile": content = <KPITile variant={variant}/>; break;
    case "gauge": content = <Gauge/>; break;
    case "calendar-heat": content = <CalendarHeat/>; break;
    case "metric-row": content = <MetricRow/>; break;
    case "feature-flag": content = <FeatureFlag/>; break;
    case "db-query": content = <DBQuery/>; break;
    case "log-viewer": content = <LogViewer/>; break;
    case "json-viewer": content = <JsonViewer/>; break;
    case "code-diff": content = <CodeDiff/>; break;
    case "token-table": content = <TokenTable/>; break;
    case "tag-cloud": content = <TagCloud/>; break;
    case "presence": content = <Presence/>; break;
    // v2 — Social / Content
    case "social-card": content = <SocialCard/>; break;
    case "blog-card": content = <BlogCard/>; break;
    case "comment-thread": content = <CommentThread/>; break;
    case "review-card": content = <ReviewCard/>; break;
    case "achievement": content = <Achievement/>; break;
    // v2 — Forms / Pickers
    case "segment": content = <SegmentControl/>; break;
    case "emoji-picker": content = <EmojiPicker/>; break;
    case "country-picker": content = <CountryPicker/>; break;
    case "currency-input": content = <CurrencyInput/>; break;
    case "gradient-builder": content = <GradientBuilder/>; break;
    case "shortcut-list": content = <ShortcutList/>; break;
    // v2 — Marketing / Animation
    case "shimmer-btn": content = <ShimmerBtn variant={variant}/>; break;
    case "bento-hero": content = <BentoHero/>; break;
    case "confetti-btn": content = <ConfettiBtn/>; break;
    default:
      content = <Stage><div className="text-sm text-mute">Preview pending.</div></Stage>;
  }

  return interactive ? content : <div className="pointer-events-none select-none">{content}</div>;
}
